...
## Other branches:
You can also check out the [`vr-support`](https://github.com/grannycola/SynthDetPhys/tree/vr-support) branch. This branch added support for Oculus devices. Tested on Quest 2.
